...
model_young = joblib.load("artifacts1/model_young_gr.joblib")
model_rest = joblib.load("artifacts1/model_rest.joblib")
scaler_young = joblib.load("artifacts1/scaler_young_gr.joblib")
